(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CreditCard"] = factory(require("React"));
	else
		root["CreditCard"] = factory(root["React"]);
...
/******/ 	__webpack_require__.p = "/Users/acharkin/reactCreditCard/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CardExpiryInput = exports.CardCVCInput = exports.CardNumberInput = exports.Card = undefined;
	...
	var _payment = __webpack_require__(97);
	...
	var cardWidthToHeightRatio = 1.75;
	var cardWidthToRatio = 21.875;
	var cardWidthToBorderRadius = 35;

	var cardLogoWidthToHeightRatio = 64 / 42;
	var cardLogoWidthRatio = 350 / 64;

	var last4 = function last4(_last) {
	  return _last != null ? ('•'.repeat(4) + " ").repeat(3) + _last : null;
	};

	var pad = function pad(numberToPad, characters, padValue) {
	  var pad_char = typeof padValue !== 'undefined' ? padValue : '0';
	  var pad = new Array(1 + characters).join(pad_char);
	  return (pad + numberToPad).slice(-pad.length);
	};

	var Card = exports.Card = function Card(props) {
	  var augmentedProps = Object.assign({}, props);
	  var cardWidth = props && props.style && props.style.width || 350;
	  ...
	  var cardLogoZoom = cardWidth / cardLogoWidthRatio / 64;

	  var cardNumber = props.last4 && last4(props.last4) || props.cardNumber && _payment2.default.fns.formatCardNumber(props.cardNumber) || Card.defaultProps.cardNumber;
	  var cardBrand = props.cardBrand && props.cardBrand.toLowerCase() || _payment2.default.fns.cardType(props.cardNumber) && _payment2.default.fns.cardType(props.cardNumber).toLowerCase();
	  var month = isNaN(props.month) ? Card.defaultProps.month : pad(props.month, 2);
	  var year = isNaN(props.year) ? Card.defaultProps.year : pad(props.year, 2);
	  var name = props.name || Card.defaultProps.name;
	  var cvc = props.cvc || Card.defaultProps.cvc;

	  return _react2.default.createElement(
	    'div',
	    _extends({}, augmentedProps, { className: (0, _classnames2.default)("creditCard", props.className, cardBrand && 'creditCard-' + cardBrand, { "creditCard-flipped": props.flipped }) }),
	    _react2.default.createElement(
	      'div',
	      { className: 'creditCard-front', style: { borderRadius: cardWidth / cardWidthToBorderRadius } },
	      _react2.default.createElement('div', { className: (0, _classnames2.default)("creditCard-logo", cardBrand && 'icon-' + cardBrand), style: { zoom: cardLogoZoom, MozTransformOrigin: "top right", MozTransform: 'scale(' + cardLogoZoom + ')' } }),
	      _react2.default.createElement('div', { className: 'creditCard-chip' }),
	      _react2.default.createElement(
	        'div',
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'creditCard-expiry' },
	        month + '/' + year
	      )
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'creditCard-back', style: { borderRadius: cardWidth / cardWidthToBorderRadius } },
	      _react2.default.createElement('div', { className: 'creditCard-magStrip' }),
	      _react2.default.createElement('div', { className: 'creditCard-signature' }),
	      _react2.default.createElement(
	        'div',
	        { className: 'creditCard-cvc' },
	        cvc
	      )
	    )
	  );
	...
	var CardNumberInput = exports.CardNumberInput = function (_React$Component) {
	  _inherits(CardNumberInput, _React$Component);

	  function CardNumberInput() {
	    _classCallCheck(this, CardNumberInput);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CardNumberInput).apply(this, arguments));
	  }

	  _createClass(CardNumberInput, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      _payment2.default.formatCardNumber(this.refs.input);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('input', _extends({ placeholder: 'Card number', type: 'text', name: 'number', ref: 'input', value: this.props.value, autoComplete: 'cc-number' }, this.props));
	    }
	  }]);
	...
	var CardCVCInput = exports.CardCVCInput = function (_React$Component2) {
	  _inherits(CardCVCInput, _React$Component2);

	  function CardCVCInput() {
	    _classCallCheck(this, CardCVCInput);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CardCVCInput).apply(this, arguments));
	  }

	  _createClass(CardCVCInput, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      _payment2.default.formatCardCVC(this.refs.input);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('input', _extends({ placeholder: 'CVC', type: 'text', name: 'number', ref: 'input', value: this.props.value, autoComplete: 'off' }, this.props));
	    }
	  }]);
	...
	var CardExpiryInput = exports.CardExpiryInput = function (_React$Component3) {
	  _inherits(CardExpiryInput, _React$Component3);

	  function CardExpiryInput(props) {
	    _classCallCheck(this, CardExpiryInput);

	    var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(CardExpiryInput).call(this, props));

	    _this3.onChange = _this3.onChange.bind(_this3);
	    return _this3;
	  }

	  _createClass(CardExpiryInput, [{
	    key: 'onChange',
	    value: function onChange(e) {
	      var _Payment$fns$cardExpi = _payment2.default.fns.cardExpiryVal(e.target.value);
	    ...
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      _payment2.default.formatCardExpiry(this.refs.input);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('input', _extends({ placeholder: 'MM/YY', type: 'text', name: 'number', ref: 'input', value: this.props.value, autoComplete: 'cc-exp', onChange: this.onChange }, this.props));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?indentedSyntax&includePaths[]=/Users/acharkin/reactCreditCard/node_modules/bourbon/app/assets/stylesheets!./index.sass", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js?indentedSyntax&includePaths[]=/Users/acharkin/reactCreditCard/node_modules/bourbon/app/assets/stylesheets!./index.sass");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./sprite-cards.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./sprite-cards.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
